    ...
    <main class="max-w-lg mx-auto mt-10 bg-gray-100 border border-gray-200 p-6 rounded-xl">
        ...
        <form method="POST" action="/register" class="mt-10">
            ...
            <div class=" mb-6">
                ...
                <input class="border border-gray-400 p-2 w-full rounded" type="password" name="password" id="password" required>
                @error('password')
                <p class="text-red-500 text-xs mt-1">{{$message}}</p>
                @enderror
            </div>
            ...
            <!-- Voor als je de errors onderaan de form wilt tonen -->
            <!-- @if ($errors->any())
            <ul>
